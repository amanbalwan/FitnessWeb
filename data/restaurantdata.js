...
const exportedMethods = {
  async createRestaurant(firstName, lastName, emailAddress, password, confirmPassword,address_line1, zipcode,age, height, weight,phoneNumber,fitnessLevel) {
  ...
  async updateRestaurant(id,address_line1, zipcode,age, height, weight,fitnessLevel){
  ...
  async checkRestaurant(emailAddress, password) {
    emailAddress = validation.stringValidation(emailAddress, "Email Address");
    emailAddress = emailAddress.toLowerCase();
    emailAddress = validation.emailValidation(emailAddress)
    password = validation.stringValidation(password, "Password");
